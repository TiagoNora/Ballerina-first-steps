...
public function getEmployee(int id) returns Employee|error {
...
public function getAllEmployees() returns Employee[]|error {
    Employee[] employees = [];
...
public function updateEmployee(Employee emp) returns int|error {
    sql:ExecutionResult result = check dbClient->execute(`
...
public function removeEmployee(int id) returns int|error {
    sql:ExecutionResult result = check dbClient->execute(`
